        ...
        <Content>
          ...
          <Row gutter={[24, 24]}>
            <Col xs={24} sm={12} md={8} lg={8} xl={8}>
              <Card style={{ width: '100%' }} cover={<img alt="Greek Salad" src="/images/Greek_Salad.jpg" />}>
                <h3>Greek Salad</h3>
            ...
            <Col xs={24} sm={12} md={8} lg={8} xl={8}>
              <Card style={{ width: '100%' }} cover={<img alt="Bruschetta" src="/images/Bruschettas.jpg" />}>
                <h3>Bruschetta</h3>
            ...
            <Col xs={24} sm={12} md={8} lg={8} xl={8}>
              <Card style={{ width: '100%' }} cover={<img alt="Lemon Dessert" src="/images/Lemon_Cake_Pops.jpg" />}>
                <h3>Lemon Dessert</h3>
